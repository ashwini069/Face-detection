...
classifier = cv2.CascadeClassifier('C:/Users/hp/Desktop/Face rocognizatino/Face rocognizatino/haarcascade_frontalface_default.xml')

model = load_model("C:/Users/hp/Desktop/Face rocognizatino/Face rocognizatino/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['ashwini', 'shubham', 'siba']
    return labels[pred]
